...
This folder defines all source code for the 'Pipeline_Transportation' pipeline:
...
* Take a look at the sample under "sample_users_pipeline_transportation.py" to get familiar with the syntax.
